...
previous_production: {
    ...
    answers: [
        ...
        { text: "Bilinmiyor", result: "Belirsizlik riski. Fiziksel-döküman uyum analizi yapılmalı." }
    ]
},
...
/* ------------------------------------------------ */
/* UYGULAMA KAPSAM ALGORİTMASI */
/* ------------------------------------------------ */

apply_open_orders: {
    text: "Açık siparişlere uygulanacak mı?",
    answers: [
        { text: "Hayır", result: "Değişiklik hiçbir açık siparişe uygulanmayacak." },
